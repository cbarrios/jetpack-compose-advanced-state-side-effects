...
fun rememberMapViewWithLifecycle(): MapView {
    ...
    // (DONE) TODO Codelab: DisposableEffect step. Make MapView follow the lifecycle
    // With the changes we've just made, the MapView will always follow the lifecycle of the current LifecycleOwner
